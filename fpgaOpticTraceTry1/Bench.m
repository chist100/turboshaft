    ...
    methods
        ...
        function draw( self, rays, draw_fl, alpha, scale, new_figure_fl )
            ...
            if new_figure_fl == 1
                ...
                figure( 'Name', [ 'OPTOMETRIKA: ' fname ],'Position', [ 0 0 1024 1024 ]);
            end
            hold on;
            for i = 1 : self.cnt
                obj = self.elem{ i };
                    ...
                    for i = 1 : length( rays ) - 1
                        ...
                        for j = 1 : size( unique_colors, 1 )
                            ...
                            plot3( [ rays( i ).r( cvis, 1 )';  rays( i + 1 ).r( cvis, 1 )' ], ...
                                   ...
                                   [ rays( i ).r( cvis, 3 )';  rays( i + 1 ).r( cvis, 3 )' ], ...
                                   sym, 'Color', unique_colors( j, : ));
                        end
                   end
...
%                 lighting phong;
        ...
        function rays = trace( self, rays_in, out_fl )
            ...
            for i = 1 : self.cnt % loop through the optic system
                if i > 17
                    rays( i + 1 ) = rays( 18 ).interaction( self.elem{ i }, out_fl );
                else
